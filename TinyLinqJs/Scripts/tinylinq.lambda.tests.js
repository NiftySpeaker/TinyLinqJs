describe("tinylinq.javascript", function () {
    function ViewModel() {
        var self = this;
    ...
    function JoinModel() {
        ...
        self.friends = viewModel.people[0].friends;
        for (var i = 0; i < viewModel.people[1].friends.length; i++)
            self.friends.push(viewModel.people[1].friends[i]);
    ...
    describe("with delegate functions", function () {
        ...
        describe(".Aggregate", function () {
            ...
            describe("overload 1: no seed, no resultSelector", function () {
                ...
                it("array has multiple strings => returns string concatination", function () {
                    //Arrange
                    var array = ["Nifty", "Scott", "Ryan"];
                    //Act
                    var result = array.Aggregate('(accum, name) => accum + "," + name');
                    //Assert
                ...
                it("array has multiple integers => returns sum of integers", function () {
                    ...
                    var array = [6, 11, 19];
                    //Act
                    var result = array.Aggregate('(accum, number) => return accum + number');
                    //Assert
                ...
                it("array has multiple objects => returns single object with same structure", function () {
                    ...
                    var result = viewModel.people.Aggregate('' +
                                                '(accum, person) => {' +
                                                'firstName: accum.firstName + "," + person.firstName, ' +
                                                'id: accum.id + "," + person.id}');
                    //Assert
                ...
                it("array has no elements => throws InvalidOperationException", function () {
                    var array = [];
                    expect(function () {
                        var result = array.Aggregate('(a, p) => { id: a.id + p.id, ' +
                                                                 'firstName: a.firstName + p.firstName }');
                ...
                it("array has exact one element => returns the value of the first element", function () {
                    ...
                    //Act
                    var result = array.Aggregate('(accum, person) => {' +
                                                'firstName: accum.firstName + "," + person.firstName, ' + 
                                                'id: accum.id + "," + person.id }');
                    //Assert
                ...
                it("array has exact one element and func returns fixed value => returns the value of the first element", function () {
                    ...
                    array.push({ id: 1, firstName: 'Nifty', lastName: "Code", friends: [] });
                    //Act
                    var result = array.Aggregate('(accum, person) => 20');
                    //Assert
                    expect(result.firstName).toBe("Nifty");
                    expect(result.id).toBe(1);
                });
            ...
            describe("overload 2: with seed, no resultSelector", function () {
                ...
                it("first argument is a function, throws a TypeLoadException", function () {
                    //Act
                    expect(function () {
                        var result = viewModel.people.Aggregate('() => "something"', '() => "other something"');
                ...
                it("array has multiple strings => returns string concatination", function () {
                    //Act
                    var result = viewModel.people.Aggregate("*", '(a, p) => a + "," + p.firstName');
                    //Assert
                ...
                it("array has multiple integers => returns sum of integers", function () {
                    ...
                    var array = [6, 11, 19];
                    //Act
                    var result = array.Aggregate(0, '(accum, number) => accum + number');
                    //Assert
                    expect(result).toBe(36);
                });
                ...
                it("array has multiple objects => returns single object with same structure", function () {
                    //Act
                    var result = viewModel.people.Aggregate({id:0, firstName: ""}, '(accum, person) => {' +
                            'firstName: accum.firstName + "," + person.firstName,' + 
                            'id: accum.id + "," + person.id}');
                    //Assert
                    expect(result.firstName).toBe(",Nifty,Scott,Steven,Ryan,Jon");
                ...
                it("array has no elements => returns seed", function () {
                    ...
                    var array = [];
                    //Act
                    var result = array.Aggregate({ id: 0, firstName: "x", lastName: "y" },
                                                    '(a, p) => ' +
                                                        '{ id: a.id + p.id, ' +
                                                        'firstName: a.firstName + p.firstName }');
                    //Assert
                ...
                it("array has exact one element and func returns fixed value => returns the fixed value", function () {
                    ...
                    array.push({ id: 1, firstName: 'Nifty', lastName: "Code", friends: [] });
                    //Act
                    var result = array.Aggregate({ id: 42, firstName: 'a', lastName: "b", friends: [] },
                                                 '(accum, person) => {' + 
                                                 'id: 0, firstName: "x", ' +
                                                 'lastName: "y", friends: [] }');
                    //Assert
            ...
            describe("overload 3: with seed and with resultSelector", function () {
                ...
                it("third argument is not a function, throws a TypeLoadException", function () {
                    //Act
                    expect(function () {
                        var result = viewModel.people.Aggregate("seed", 
                                            '() => { id: 0, firstName: "x", lastName: "y", friends: [] }',
                                            "not a function");
                ...
                it("array has multiple objects => returns single object with same structure", function () {
                    ...
                    var result = viewModel.people.Aggregate(
                        { sum: 0, count: 0 },
                        '(accum, person) => {sum: accum.sum + person.id, count: ++accum.count}',
                        '(accum) => accum.sum / accum.count');
                    //Assert
        ...
        describe(".All", function () {
            ...
            it("array is empty, result should be true", function () {
                viewModel.people.splice(0, viewModel.people.length);
                
                var bool = viewModel.people.All('p => p.firstName.length > 4');
            ...
            it("predicate is not a function, should throw an ArgumentNullException", function () {
                expect(function () {
                    var bool = viewModel.people.All('not a function');
            ...
            it("All has only correct conditions, should return true", function () {
                var bool = viewModel.people.All('p => p.id < 10');
        ...
        describe(".Any", function () {
            ...
            it("array is empty, result should be false", function () {
                viewModel.people.splice(0, viewModel.people.length);
                var bool = viewModel.people.Any('p => p.firstName.length > 4');

                expect(bool).toBe(false);
            });

            it("array has only wrong conditions, result should be false", function () {
                var bool = viewModel.people.Any('p => p.id > 10');
        ...
        describe(".Average", function () {
            ...
            it("with selector and empty array, throws InvalidOperationException", function () {
                var array = [];
                expect(function () {
                    var person = array.Average('p => p.id > 2');
                }).toThrowError("InvalidOperationException: The sequence contains no elements")
            });
            ...
            it("returns integer", function () {
                var avg = viewModel.people.Average('p => p.id');
                expect(avg).toBe(3);
            });
        ...
        describe(".Concat", function () {
            ...
            it("with array argument, returns combined array", function () {
                //Arrange
                var second = [];
            ...
            it("with empty array argument, returns original array", function () {
                //Arrange
                var second = [];
                //Act
                var third = viewModel.people.Concat(second);
            ...
            it("with array argument and origial is empty, returns array argument", function () {
                //Arrange
                var second = [];
                second.push({ id: 6, firstName: 'Rob', lastName: "Connery" });
                second.push({ id: 7, firstName: 'Scott', lastName: "Guthrie" });
            ...
            it("with Array argument and origial is empty, returns Array argument as array", function () {
                //Arrange
                var second = [];
                second.push({ id: 6, firstName: 'Rob', lastName: "Connery" });
                second.push({ id: 7, firstName: 'Scott', lastName: "Guthrie" });
            ...
            it("with empty Array argument and origial is empty, returns empty array", function () {
                //Arrange
                var second = [];
                viewModel.people.splice(0, viewModel.people.length);
                //Act
        ...
        describe(".Count", function () {
            ...
            it("with argument, returns number of matching elements", function () {
                var i = viewModel.people.Count('p => p.id > 3');
                expect(i).toBe(2);
            });

            it("with no matching predicate, returns zero", function () {
                var i = viewModel.people.Count('p => p.id < 0');
                expect(i).toBe(0);
            });
        ...
        describe(".DefaultIfEmpty", function () {
            ...
            it("array without underlying with no argument, returns array with one row = null", function () {
                var newArray = [];
            ...
            it("empty array with no argument, returns array with one row = null", function () {
                var newArray = [];
                var result = newArray.DefaultIfEmpty();
                expect(result.length).toBe(1);
                expect(result[0]).toBe(null);
            ...
            it("empty array with defaultValue, returns array with one row = defaultValue", function () {
                var newArray = [];
            ...
            it("filled array with no argument, returns array", function () {
            ...
            it("filled array with argument, returns array", function () {
        ...
        describe(".Except", function () {
            ...
            describe("without equalityComparer", function () {
                ...
                it("second argument has different elements as input sequence, returns input sequence", function () {
                    //Arrange
                    var array = viewModel.people[0].friends;
                    //Act
                    var result = viewModel.people.Except(array);
                    //Assert
                    expect(result.length).toBe(5);
        ...
        describe(".First", function () {
            ...
            it("with argument and empty array, throws InvalidOperationException", function () {
                var array = [];
                expect(function () {
                    var person = array.First('p => return p.id > 2');
                }).toThrowError("InvalidOperationException: The sequence contains no elements")
            });
            ...
            it("with predicate, returns first matching element", function () {
                var person = viewModel.people.First('p => p.id > 2');
                expect(person.firstName).toBe("Steven");
            });

            it("with wrong predicate, throws InvalidOperationException", function () {
                expect(function () {
                    var person = viewModel.people.First('p => p.id > 200');
        ...
        describe(".FirstOrDefault", function () {
            ...
            it("with argument and empty array, returns null", function () {
                var array = [];
                var person = array.FirstOrDefault('p => p.id > 2');
                expect(person).toBe(null);
            });
            ...
            it("with predicate, returns first matching element", function () {
                var person = viewModel.people.FirstOrDefault('p => p.id > 2');
                expect(person.firstName).toBe("Steven");
            });

            it("with wrong predicate, returns null", function () {
                var person = viewModel.people.FirstOrDefault('p => p.id > 200');
                expect(person).toBe(null);
            });
        ...
        describe(".GroupBy", function () {
            ...
            describe("with keySelector", function () {
                ...
                it("array is empty, returns empty array", function () {
                    ...
                    viewModel.people.splice(0, viewModel.people.length);
                    //Act
                    var result = viewModel.people.GroupBy('p => p.firstName');
                    //Assert
                    expect(result.length).toBe(0);
                    expect(arraysAreDifferent(viewModel.people, result)).toBe(true);
                });
                ...
                it("all elements in the array have the same key, returns a single group for all elements", function () {
                    ...
                    //Act
                    var result = viewModel.people.GroupBy('p => p.myKey');
                    //Assert
                    expect(result.length).toBe(1);
            ...
            describe("with keySelector and elementSelector", function () {
                ...
                it("array is empty, returns empty array", function () {
                    ...
                    viewModel.people.splice(0, viewModel.people.length);
                    //Act
                    var result = viewModel.people.GroupBy('p => p.firstName', 'p => p.lastName');
                    //Assert
                    expect(result.length).toBe(0);
                    expect(arraysAreDifferent(viewModel.people, result)).toBe(true);
                });
                ...
                it("all elements in the array have the same key, returns a single group for all elements", function () {
                    ...
                    //Act
                    var result = viewModel.people.GroupBy('p => p.myKey', 'p => p.lastName');
                    //Assert
                    expect(result.length).toBe(1);
                    expect(result[0].Key).toBe("Stan");
                    expect(result[0].length).toBe(5);
            ...
            describe("with keySelector, elementSelector and resultSelector", function () {
                ...
                it("array is empty, returns empty array", function () {
                    ...
                    var result = viewModel.people.GroupBy('p => p.firstName',
                                                          'p => p.lastName',
                                                          '(key, values) => { Key: key, Count: values.Count() }');
                    //Assert
                    expect(result.length).toBe(0);
                    expect(arraysAreDifferent(viewModel.people, result)).toBe(true);
                });
            ...
            describe("with keySelector, elementSelector, resultSelector and equalityComparer", function () {
                ...
                it("some elements in the array have the same key, returns a array of groups", function () {
                    //Act
                    var result = viewModel.people.GroupBy('p => p',
                                                          'p => p.lastName',
                                                          '(key, values) => { Key: key, Count: values.Count() }',
                                                          function (p1, p2) {
                                                              return p1.firstName.substr(0, 1) == p2.firstName.substr(0, 1);
        ...
        describe(".GroupJoin", function () {
            ...
            it("without innerKeySelector argument, throws ArgumentNullException", function () {
                expect(function () {
                    viewModel.people.GroupJoin(joinModel, 'p => p.firstName');
            ...
            it("without resultSelector argument, throws ArgumentNullException", function () {
                expect(function () {
                    viewModel.people.GroupJoin(joinModel, 'p => p.firstName', 'p => p.firstName');
            ...
            it("with inner sequence argument is not an array, throws TypeLoadException", function () {
                expect(function () {
                    viewModel.people.GroupJoin({ someProperty: "not an array" }, 
                                               'p => p.firstName', 
                                               'p => p.firstName',
                                               '(p, f) => { person: p, friend: f }');
            ...
            it("with outerKeySelector argument is not a function, throws TypeLoadException", function () {
                expect(function () {
                    viewModel.people.GroupJoin(joinModel.friends, 
                                               "not a function", 
                                               'p => p.firstName',
                                               '(p, f) => { person: p, friend: f }');
            ...
            describe("with single key selectors and without equalityComparer", function () {
                ...
                it("outer sequence is empty, returns empty array", function () {
                    ...
                    expect(result.length).toBe(0);
                    expect(arraysAreDifferent(viewModel.people, result)).toBe(true);
                    expect(arraysAreDifferent(joinModel.friends, result)).toBe(true);
                });
            ...
            describe("with multi key selectors and without equalityComparer", function () {
                ...
                it("outer sequence is empty, returns empty array", function () {
                    ...
                    //Act
                    var result = viewModel.people.GroupJoin(joinModel.friends,
                                                            'p => {fn: p.firstName, ln: p.lastName }',
                                                            'f => {fn: f.firstName, ln: f.lastName }',
                                                            '(p, f) => { person: p, friends: f }');
                    //Assert
                    expect(result.length).toBe(0);
                    expect(arraysAreDifferent(viewModel.people, result)).toBe(true);
            ...
            describe("with multi key selectors and with equalityComparer", function () {
                ...
                it("without matching elements, returns empty array", function () {
                    ...
                    var result = viewModel.people.GroupJoin(joinModel.friends,
                                                            ...
                                                            '(p, f) => { person: p, friends: f }',
                                                            function (k1, k2) {
                                                                return k1.fn === k2.fn && k1.ln === k2.ln;
                                                            }
                    );
                    //Assert
                    expect(result.length).toBe(0);
        ...
        describe(".Join", function () {
            ...
            it("without innerKeySelector argument, throws ArgumentNullException", function () {
                expect(function () {
                    viewModel.people.Join(joinModel, 'p => p.firstName');
                }).toThrowError("ArgumentNullException: Missing innerKeySelector");
            });

            it("without resultSelector argument, throws ArgumentNullException", function () {
                expect(function () {
                    viewModel.people.Join(joinModel, 'p => p.firstName', 'f => f.firstName');
                }).toThrowError("ArgumentNullException: Missing resultSelector");
            });

            it("with inner sequence argument is not an array, throws TypeLoadException", function () {
                expect(function () {
                    viewModel.people.Join({ someProperty: "not an array" },
                                            'p => p.firstName',
                                            'f => f.firstName',
                                            '(p, f) => { person: p, friend: f }');
                }).toThrowError("TypeLoadException: Argument inner is not an array");
            ...
            it("with outerKeySelector argument is not a function, throws TypeLoadException", function () {
                expect(function () {
                    viewModel.people.Join(joinModel.friends,
                                          "not a function",
                                          'f => f.firstName',
                                          '(p, f) => { person: p, friend: f }');
                }).toThrowError("TypeLoadException: Argument outerKeySelector is not a function");
        ...
        describe(".Max", function () {
            ...
            it("returns max negative value", function () {
                for (var i = 0; i < viewModel.people.length; i++) {
                    viewModel.people[i].id = viewModel.people[i].id * -1;
                }
        ...
        describe(".OfType", function () {
            ...
            var array = [];
            beforeEach(function () {
                array = ['string1', 1, { id: 1, firstName: 'Nifty', lastName: 'Code' }, [], 'string2', function () { return 1; }, 2, true, 7.5, false, 3.5];
            });
        ...
        describe(".OrderBy", function () {
            ...
            describe("without comparer", function () {
                ...
                it("input secuence is empty, returns empty array", function () {
                    ...
                    var array = [];
                    //Act
                    var result = array.OrderBy('p => p.firstName');
                    //Assert
                    expect(result.length).toBe(0);
                    expect(result.SortKeys[0].dir).toBe("asc");
                    expect(result.SortKeys[0].key).toBe(tinylinq.Func('p => p.firstName'));
                    expect(arraysAreDifferent(array, result)).toBe(true);
                });
                ...
                it("all input elements have same key, preserves order", function () {
                    ...
                    //Act
                    var result = viewModel.people.OrderBy('p => p.key');
                    //Assert
                    expect(result.length).toBe(5);
                    expect(result[0].firstName).toBe('Nifty');
                    expect(result[1].firstName).toBe('Scott');
                ...
                it("all input elements have different key, changes order", function () {
                    //Act
                    var result = viewModel.people.OrderBy('p => p.firstName');
                    //Assert
                    expect(result.length).toBe(5);
            ...
            describe("with comparer", function () {
                ...
                it("input secuence is empty, returns empty array", function () {
                    ...
                    var array = [];
                    //Act
                    var result = array.OrderBy('p => p.firstName', comparer);
                    //Assert
                    expect(result.length).toBe(0);
                    expect(result.SortKeys[0].dir).toBe("asc");
                    expect(arraysAreDifferent(array, result)).toBe(true);
                ...
                it("all input elements have same key, preserves order", function () {
                    ...
                    //Act
                    var result = viewModel.people.OrderBy('p => p.key', function (x, y) {
                        if (x.key < y.key)
                            return -1;
                        if (x.key > y.key)
                            return 1;
                ...
                it("all input elements have different key, changes order", function () {
                    //Act
                    var result = viewModel.people.OrderBy('p => p.firstName', comparer);
                    //Assert
                    expect(result.length).toBe(5);
                    expect(result[0].firstName).toBe('Jon');
        ...
        describe(".OrderByDescending", function () {
            ...
            describe("without comparer", function () {
                ...
                it("input secuence is empty, returns empty array", function () {
                    ...
                    //Act
                    var result = array.OrderByDescending('p => p.firstName');
                    //Assert
                    expect(result.length).toBe(0);
                ...
                it("all input elements have same key, preserves order", function () {
                    ...
                    //Act
                    var result = viewModel.people.OrderByDescending('p => p.key');
                    //Assert
                    expect(result.length).toBe(5);
                    expect(result[0].firstName).toBe('Nifty');
                    expect(result[1].firstName).toBe('Scott');
                ...
                it("all input elements have different key, changes order", function () {
                    //Act
                    var result = viewModel.people.OrderByDescending('p => p.firstName');
                    //Assert
                    expect(result.length).toBe(5);
            ...
            describe("with comparer", function () {
                ...
                it("input secuence is empty, returns empty array", function () {
                    ...
                    var array = [];
                    //Act
                    var result = array.OrderByDescending('p => p.firstName', comparer);
                    //Assert
                    expect(result.length).toBe(0);
                    expect(result.SortKeys[0].comp).toBe(comparer);
                    expect(result.SortKeys[0].dir).toBe("desc");
                ...
                it("all input elements have same key, preserves order", function () {
                    ...
                    //Act
                    var result = viewModel.people.OrderByDescending('p => p.key', function (x, y) {
                        if (x.key < y.key)
                            return 1;
                        if (x.key > y.key)
                            return -1;
                ...
                it("all input elements have different key, changes order", function () {
                    //Act
                    var result = viewModel.people.OrderByDescending('p => p.firstName', comparer);
                    //Assert
                    expect(result.length).toBe(5);
                    expect(result[0].firstName).toBe('Steven');
                    expect(result[1].firstName).toBe('Nifty');
        ...
        describe(".Reverse", function () {
            ...
            it("reverse the input array, returns reversed array", function () {
                //Act
                var result = viewModel.people.Reverse();
                //Assert
                expect(result[0].firstName).toBe("Jon");
        ...
        describe(".Select", function () {
            ...
            it("with selector, returns mapped array", function () {
                var result = viewModel.people.Select('p => { No: p.id, Name: p.firstName + " " + p.lastName }');
            ...
            it("with selector which acceptes index parameter, returns mapped array", function () {
                var result = viewModel.people.Select('(p, i) => { No: (10 - i), Name: p.firstName + " " + p.lastName }');
        ...
        describe(".SelectMany", function () {
            ...
            describe("with collectionSelector, without resultSelector", function () {
                ...
                it("and index parameter is expected, returns flat array of objects", function () {
                    //Act
                    var result = viewModel.people.SelectMany('(p, index) => { '+ 
                                                                            'console.log(index);' + 
                                                                            'return p.friends; ' +
                                                                            '}');
                    //Assert
                ...
                it("but one subArray is null, throws a TypeLoadException", function () {
                    ...
                    //Act / Assert
                    expect(function () {
                        viewModel.people.SelectMany('p => p.friends');
                    }).toThrowError("TypeLoadException: The collectionsSelector does not return an array");
                });
                ...
                it("and sub array is an array, returns flat array of objects", function () {
                    //Arrange
                    viewModel.people[0].friends = viewModel.people[0].friends;
                    viewModel.people[1].friends = viewModel.people[1].friends;
            ...
            describe("with collectionSelector, with resultSelector", function () {
                it("returns flat array of anonymuous objects", function () {
                    ...
                    var result = viewModel.people.SelectMany('p => p.friends',
                                                            '(p, f) => { ' +
                                                                'text: f.firstName + " is friend of " + p.firstName }');
        ...
        describe(".SingleOrDefault", function () {
            ...
            describe("with predicate", function () {
                ...
                it("and it has more than one matching entries, throw InvalidOperationException", function () {
                    expect(function () {
                        viewModel.people.SingleOrDefault('p => p.id < 4');
                    }).toThrowError("InvalidOperationException: The sequence contains more than one element");
                });
        ...
        describe(".Single", function () {
            ...
            describe("with predicate", function () {
                ...
                it("and empty array, throw InvalidOperationException", function () {
                    ...
                    //Act / Assert
                    expect(function () {
                        array.Single('p => p.id > 2');
                    }).toThrowError("InvalidOperationException: The sequence contains no matching element");
                });

                it("and it has more than one matching entries, throw InvalidOperationException", function () {
                    expect(function () {
                        viewModel.people.Single('p => p.id < 4');
                    }).toThrowError("InvalidOperationException: The sequence contains more than one element");
                });
                ...
                it("and array has exact one entry which matches, returns entry", function () {
                    var ary = [];
                    ary.push(viewModel.people[0]);
                    var person = ary.Single('p => p.id < 2');
                    expect(person.firstName).toBe("Nifty");
                });
                ...
                it("and array has multiple entries but no one matches, returns throw InvalidOperationException", function () {
                    expect(function () {
                        viewModel.people.Single('p => p.id > 200');
                    }).toThrowError("InvalidOperationException: The sequence contains no matching element");
                });
        ...
        describe(".Skip", function () {
            ...
            it("count is zero, returns complete array", function () {
                //Act
            ...
            it("count is equal to the length of the array, returns empty array", function () {
                //Act
            ...
            it("count is greater than the length of the array, returns empty array", function () {
                //Act
            ...
            it("count is lower than zero, returns complete array", function () {
                //Act
        ...
        describe(".SkipWhile", function () {
            ...
            it("predicate argument has no match, returns empty array", function () {
                //Act
                var result = viewModel.people.SkipWhile('p => p.id < 100');
            ...
            it("predicate argument matches first element, returns complete array", function () {
                //Act
                var result = viewModel.people.SkipWhile('p => p.id < 0');
        ...
        describe(".Sum", function () {
            ...
            it("with selector and empty array, returns zero", function () {
                var array = [];
                var sum = array.Sum('p => p.id > 2');
                expect(sum).toBe(0);
            });

            it("with selector, returns integer", function () {
                var sum = viewModel.people.Sum('p => p.id');
                expect(sum).toBe(15);
            });
        ...
        describe(".TakeWhile", function () {
            ...
            it("predicate argument has no match, returns complete array", function () {
                //Act
                var result = viewModel.people.TakeWhile('p => p.id < 100');
            ...
            it("predicate argument matches first element, returns empty array", function () {
                //Act
                var result = viewModel.people.TakeWhile('p => p.id < 0');
        ...
        describe(".ThenBy", function () {
            ...
            describe("one ThenBy call, without comparer", function () {
                ...
                it("input secuence is empty, returns empty array", function () {
                    ...
                    expect(result.length).toBe(0);
                    expect(result.SortKeys[0].dir).toBe("asc");
                    expect(result.SortKeys[0].key.toString()).toBe(tinylinq.Func('p => p.firstName').toString());
                    expect(result.SortKeys[1].dir).toBe("asc");
                    expect(result.SortKeys[1].key.toString()).toBe(tinylinq.Func('p => p.lastName').toString());
                    expect(arraysAreDifferent(array, result)).toBe(true);
                });
                ...
                it("all input elements have same key, preserves order", function () {
                    ...
                    //Act
                    var result = viewModel.people.OrderBy('p => p.key').ThenBy('p => p.key');
                    //Assert
                    expect(result.length).toBe(5);
                    expect(result[0].firstName).toBe('Nifty');
                    expect(result[1].firstName).toBe('Scott');
                ...
                it("all input elements have different ThenBy key, changes order", function () {
                    ...
                    //Act
                    var result = viewModel.people.OrderBy('p => p.key').ThenBy('p => p.firstName');
                    //Assert
                    expect(result.length).toBe(5);
                    expect(result[0].firstName).toBe('Jon');
                    expect(result[1].firstName).toBe('Nifty');
                ...
                it("all input elements have different key (OrderBy and ThenBy keys), changes order", function () {
                    ...
                    //Act
                    var result = viewModel.people.OrderBy('p => p.firstName').ThenBy('p => p.lastName');
                    //Assert
                    expect(result.length).toBe(10);
                    expect(result[0].firstName).toBe('Dave');
                    expect(result[1].firstName).toBe('Jon');
            ...
            describe("one ThenBy call, with comparer", function () {
                ...
                it("all input elements have same key, preserves order", function () {
                    ...
                    //Act
                    var result = viewModel.people.OrderBy('p => p.key').ThenBy('p => p.key', function (x, y) {
                        if (x.key < y.key)
                            return -1;
                        if (x.key > y.key)
                            return 1;
                ...
                it("all input elements have different ThenBy key, changes order", function () {
                    ...
                    //Act
                    var result = viewModel.people.OrderBy('p => p.key').ThenBy('p => p.firstName', comparer);
                    //Assert
                    expect(result.length).toBe(5);
                    expect(result[0].firstName).toBe('Jon');
                    expect(result[1].firstName).toBe('Ryan');
                ...
                it("some input elements have different key (OrderBy and ThenBy keys), changes order", function () {
                    ...
                    //Act
                    var result = viewModel.people.OrderBy('p => p.firstName').ThenBy('p => p.lastName', comparer);
                    //Assert
                    expect(result.length).toBe(10);
                    expect(result[0].firstName).toBe('Dave');
                    expect(result[1].firstName).toBe('Jon');
            ...
            describe("two ThenBy calls, without comparer", function () {
                ...
                it("input secuence is empty, returns empty array", function () {
                    ...
                    var array = [];
                    //Act
                    var result = array.OrderBy('p => p.firstName.length + p.lastName.length')
                                      .ThenBy('p => p.firstName')
                                      .ThenBy('p => p.lastName');
                    //Assert
                    expect(result.length).toBe(0);
                    expect(result.SortKeys[0].dir).toBe("asc");
                    expect(result.SortKeys[0].key.toString()).toBe(tinylinq.Func('p => p.firstName.length + p.lastName.length').toString());
                    expect(result.SortKeys[1].dir).toBe("asc");
                    expect(result.SortKeys[1].key.toString()).toBe(tinylinq.Func('p => p.firstName').toString());
                    expect(result.SortKeys[2].dir).toBe("asc");
                    expect(result.SortKeys[2].key.toString()).toBe(tinylinq.Func('p => p.lastName').toString());
                    expect(arraysAreDifferent(array, result)).toBe(true);
                });
                ...
                it("with three different key selectors (OrderBy, ThenBy and ThenBy), changes order", function () {
                    ...
                    //Act
                    var result = viewModel.people.OrderBy('p => p.firstName.length + p.lastName.length');

                    result = result.ThenBy('p => p.firstName');

                    result = result.ThenBy('p => p.lastName');
                    //Assert
                    expect(result.length).toBe(10);
                    expect(result[0].firstName).toBe('Dave');
        ...
        describe(".ThenByDescending", function () {
            ...
            describe("one ThenByDescending call, without comparer", function () {
                ...
                it("all input elements have same key, preserves order", function () {
                    ...
                    //Act
                    var result = viewModel.people.OrderBy('p => p.key').ThenByDescending('p => p.key');
                    //Assert
                    expect(result.length).toBe(5);
                    expect(result[0].firstName).toBe('Nifty');
                    expect(result[1].firstName).toBe('Scott');
                ...
                it("all input elements have different ThenBy key, changes order", function () {
                    ...
                    //Act
                    var result = viewModel.people.OrderBy('p => p.key').ThenByDescending('p => p.firstName');
                    //Assert
                    expect(result.length).toBe(5);
                    expect(result[0].firstName).toBe('Steven');
                    expect(result[1].firstName).toBe('Scott');
                ...
                it("all input elements have different key (OrderBy and ThenBy keys), changes order", function () {
                    ...
                    //Act
                    var result = viewModel.people.OrderBy('p => p.firstName').ThenByDescending('p => p.lastName');
                    //Assert
                    expect(result.length).toBe(10);
                    expect(result[0].firstName).toBe('Dave');
                    expect(result[1].firstName).toBe('Jon');
            ...
            describe("one ThenByDescending call, with comparer", function () {
                ...
                it("input secuence is empty, returns empty array", function () {
                    ...
                    //Act
                    var result = array.OrderBy('p => p.firstName')
                                      .ThenByDescending('p => p.lastName', comparer);
                    //Assert
                    expect(result.length).toBe(0);
                    expect(result.SortKeys[0].dir).toBe("asc");
                    expect(result.SortKeys[0].key.toString()).toBe(tinylinq.Func('p => p.firstName').toString());
                ...
                it("all input elements have same key, preserves order", function () {
                    ...
                    //Act
                    var result = viewModel.people.OrderBy('p => p.key').ThenByDescending('p => p.key', function (x, y) {
                        if (x.key < y.key)
                            return -1;
                        if (x.key > y.key)
                            return 1;
                ...
                it("all input elements have different ThenBy key except of two, changes order: the two preserve order", function () {
                    ...
                    //Act
                    var result = viewModel.people.OrderBy('p => p.key').ThenByDescending('p => p.firstName', comparer);
                    //Assert
                    expect(result.length).toBe(5);
                    expect(result[0].firstName).toBe('Steven');
                    expect(result[1].firstName).toBe('Nifty');
                ...
                it("some input elements have different key (OrderBy and ThenBy keys), changes order", function () {
                    ...
                    //Act
                    var result = viewModel.people.OrderBy('p => p.firstName').ThenByDescending('p => p.lastName', comparer);
                    //Assert
                    expect(result.length).toBe(10);
                    expect(result[0].firstName).toBe('Dave');
                    expect(result[1].firstName).toBe('Jon');
            ...
            describe("two ThenByDescending calls, without comparer", function () {
                ...
                it("with three different key selectors (OrderBy, ThenBy and ThenBy), changes order", function () {
                    ...
                    result = result.ThenByDescending('p => p.firstName');

                    result = result.ThenByDescending('p => p.lastName');
                    //Assert
                    expect(result.length).toBe(10);
                    expect(result[0].firstName).toBe('Jon');
                    expect(result[0].lastName).toBe('Skeet');
            ...
            describe("first one is ThenBy and second one is ThenByDescending call, without comparer", function () {
                ...
                it("all input elements have same key, preserves order", function () {
                    ...
                    //Act
                    var result = viewModel.people.OrderBy('p => p.key').ThenBy('p => p.key').ThenByDescending('p => p.key');
                    //Assert
                    expect(result.length).toBe(5);
                    expect(result[0].firstName).toBe('Nifty');
                    expect(result[1].firstName).toBe('Scott');
            ...
            describe("first one is ThenByDescending and second one is ThenBy call, without comparer", function () {
                ...
                it("all input elements have same key, preserves order", function () {
                    ...
                    //Act
                    var result = viewModel.people.OrderBy('p => p.key').ThenByDescending('p => p.key').ThenBy('p => p.key');
                    //Assert
                    expect(result.length).toBe(5);
                    expect(result[0].firstName).toBe('Nifty');
                    expect(result[1].firstName).toBe('Scott');
        ...
        describe(".ToArray", function () {
            ...
            it("array has no element, returns empty array", function () {
                //Arrange
                var array = [];
                //Act
        ...
        describe(".ToDictionary (Simulating a Dictionary with an Javascript object)", function () {
            ...
            describe("only with keySelector", function () {
                ...
                it("array which is empty, returns empty Dictionary", function () {
                    ...
                    var array = [];
                    //Act
                    var result = array.ToDictionary('p => p.firstName');
                    //Assert
                ...
                it("array of unique objects, returns Dictionary", function () {
                    //Act
                    var result = viewModel.people.ToDictionary('p => p.firstName');
                    //Assert
            ...
            describe("with keySelector and elementSelector", function () {
                ...
                it("and elementSelector is not a function, throws TypeLoadException", function () {
                    expect(function () {
                        viewModel.people.ToDictionary('p => p.firstName',
                                                      "Not a function");
                    }).toThrowError("TypeLoadException: Argument elementSelector is not a function");
                });
        ...
        describe(".ToLookup", function () {
            ...
            describe("with keySelector", function () {
                ...
                it("array is empty, returns empty array", function () {
                    ...
                    viewModel.people.splice(0, viewModel.people.length);
                    //Act
                    var result = viewModel.people.ToLookup('p => p.firstName');
                    //Assert
                    expect(result.length).toBe(0);
                    expect(arraysAreDifferent(viewModel.people, result)).toBe(true);
                });
                ...
                it("all elements in the array have the same key, returns a single group for all elements", function () {
                    ...
                    //Act
                    var result = viewModel.people.ToLookup('p => p.myKey');
                    //Assert
                    expect(result.length).toBe(1);
                    expect(result[0].Key).toBe("Stan");
                    expect(result[0].length).toBe(5);
            ...
            describe("with keySelector and equalityComparer", function () {
                ...
                it("some elements in the array have the same key, returns a array of groups", function () {
                    //Act
                    var result = viewModel.people.ToLookup('p => p',
                                                          null,
                                                          function (p1, p2) {
                                                              return p1.firstName.substr(0, 1) == p2.firstName.substr(0, 1);
                                                          });
        ...
        describe(".Where", function () {
            ...
            it("empty array, returns empty array", function () {
                var array = [];
                var result = array.Where('p => p.id > 2');
                expect(result.length).toBe(0);
                //Check that original Array(s) have not been mutated
            ...
            it("has more than one matching entries, returns matching elements", function () {
                //Act
                var result = viewModel.people.Where('p => p.id < 4 && p.id > 1');
                //Assert
                expect(result.length).toBe(2);
            ...
            it("has more than one matching entries and predicate uses index, returns matching elements", function () {
                //Act
                var result = viewModel.people.Where('(p, i) => p.id > 1 && i < 3');
                //Assert
                expect(result.length).toBe(2);
                expect(result[0].firstName).toBe("Scott");
                //Check that original Array(s) have not been mutated
            ...
            it("array has exact one entry which matches, returns array with one element", function () {
                //Arrange
                var array = [];
                array.push(viewModel.people[0]);
                //Act
            ...
            it("array has multiple entries but only one matches, returns array with one element", function () {
                var result = viewModel.people.Where('p => p.id < 2');
                expect(result.length).toBe(1);
                expect(result[0].firstName).toBe("Nifty");
                //Check that original Array(s) have not been mutated
                expect(viewModel.people.length).toBe(5);
            ...
            it("array has multiple entries but no one matches, returns empty array", function () {
                var result = viewModel.people.Where('p => p.id > 200');
                expect(result.length).toBe(0);
                //Check that original Array(s) have not been mutated
                expect(viewModel.people.length).toBe(5);
                expect(arraysAreDifferent(viewModel.people, result)).toBe(true);
        ...
        describe(".Zip", function () {
            ...
            it("with empty input array, returns empty array", function () {
                ...
                viewModel.people.splice(0, viewModel.people.length);
                //Act
                var result = viewModel.people.Zip(array, '(p1, p2) => { p1: p1, p2: p2 }');
                //Assert
                expect(result.length).toBe(0);
                expect(arraysAreDifferent(viewModel.people, result)).toBe(true);
                expect(arraysAreDifferent(array, result)).toBe(true);
            ...
            it("with input array longer than second array, returns array with length of second", function () {
                //Arrange
                var inputArray = viewModel.people[0].friends;
                var secondArray = viewModel.people[1].friends;
                //Act
                var result = inputArray.Zip(secondArray, '(p1, p2) => { p1: p1, p2: p2 }');
                //Assert
                expect(result.length).toBe(2);
                expect(result[0].p1.firstName).toBe("Rob");
                expect(result[0].p2.firstName).toBe("Justin");
                expect(arraysAreDifferent(inputArray, result)).toBe(true);
                expect(arraysAreDifferent(secondArray, result)).toBe(true);
            });

            it("with input array longer than second array, returns array with length of second", function () {
                //Arrange
                var inputArray = viewModel.people[1].friends;
                var secondArray = viewModel.people[0].friends;
                //Act
                var result = inputArray.Zip(secondArray, '(p1, p2) => { p1: p1, p2: p2 }');
                //Assert
                expect(result.length).toBe(2);
